...
/**
 * The main GUI class representing the application frame.
 * Allows the user to compress and decompress files.
 * 
 * @author Pintu Giri
 */
public class AppFrame extends JFrame implements ActionListener {
    ...
    AppFrame(){
        ...
        this.setSize(400, 200); // Adjusted size for better visibility
